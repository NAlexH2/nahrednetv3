...
import SafeWebsite from "/public/images/projectImages/SafeWebsite.png";
      ...
      <div className="my-8 mx-5">
        ...
        <p className="float-left mr-10 mb-2">
          ...
          <ul className={`${ClassStyles.CustomList} float-left`}>
            ...
            <li className="mt-1 ml-5">
              <Link href="https://pm2.keymetrics.io/" id={IDStyles.UniLink}>
                PM2
              </Link>
            </li>
        ...
        <div className="text-justify">
          <p>
            ...
            within the community called a &#34;Capstone Project&#34;. The
            purpose of this project is to not only give back to the Portland
            community in some way, but to also demonstrate the skills and
            abilities we have learned in the years we&#39;ve attended PSU.
            <p className="mt-3">
              These projects are essentially auctioned off to the team who is
              the most convincing they can succeed at it. Teams are selected by
              the people who requested to be a team lead at the start of the
              first term. The SAFE project was in high-demand by all teams as it
              was something people felt was important - a project that gave back
              not to any community, the community we were all part of: PSU&#39;s
          ...
          <p className="mt-3">
            ...
            done natively by modifying CSS attributes directly or using a
            styling component.
          </p>
          <p className="mt-3">
