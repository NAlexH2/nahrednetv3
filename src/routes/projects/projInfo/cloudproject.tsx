...
import CloudLambda from "/public/images/projectImages/esrb_lambda.png";
import JinjaTemplate from "/public/images/projectImages/jinja_template.png";
    ...
    <AnimateTx>
      <div className="my-8 mx-5">
        ...
        <p className="float-left mr-10 mb-4">
          ...
          <ul className={`${ClassStyles.CustomList}`}>
            ...
            <li className="mt-1 ml-5">
              {" "}
              <Link href="https://www.igdb.com/" id={IDStyles.UniLink}>
                IGDB
              </Link>{" "}
              and its{" "}
              <Link
            ...
            <li className="mt-1 ml-5">
              {" "}
              <Link
                href="https://cloud.google.com/vision?hl=en"
                id={IDStyles.UniLink}
              >
        ...
        <div className="text-justify">
          <p className="mt-3">
            This website was put together for a final project during Fall term
            at Portland State University, and was started the 28th of November
            2023 and completed on the 6th of December 2023. The only
            requirements that we had to be concerned with (at the graduate
            level) was that it must incorporate 2 different API. It is a Flask
            application hosted on the Google Cloud Platform (GCP) through their
            Cloud Run service using a docker image built from the source I
            produced.
          </p>
          <p className="mt-3">
            ...
            this final project! Having still wanted to make this, I elected to
            go a simpler path - allow people to query the Internet Games
            Database (IGDB) and see information regarding that search.
          </p>
          <p className="mt-3">
          ...
          <p className="mt-3">
            For example: it knows who Mario is, but not Sonic (mostly). So if
            you look up a Mario and Sonic sports game, the alt text accurately
            generates for Mario, but not Sonic... Or any of the other characters
            that appear on the box art, again, mostly.
          </p>
          <h3 className="text-[var(--toastedalmond)] underline decoration-[var(--honey)] mt-3">
            Challenges
          </h3>
          <p className="mt-3">
            ...
            app to appear in the dev environment I was using, but the IGDB API
            is particularly stale.
          </p>
          <p className="mt-3">
            When retrieving information, some of the endpoints were
            non-functional, and so there were workarounds that had to be
            performed to get the exact data I needed. This included, but not
            limited to: obtaining the exact release date, the ESRB age rating,
            and only wanting to view actual real and released games.
          </p>
          ...
          <p className="mt-3">
            I had to develop this workaround to source legit titles because of
            the limitations I had to set for both the IGDB API and Google Cloud
            Vision AI API. If the user attempted too many results, the page
            would eventually timeout instead of waiting for a response.
          </p>
          <h3 className="text-[var(--toastedalmond)] underline decoration-[var(--honey)] mt-3">
            Jinja Templates Are Pretty Cool!
          </h3>
          <p className="mt-3">
            One thing I had discovered working on this project and reading
            through documentation was that Jinja templates can smartly identify
            which HTML components to render based on if the response data was
            returned with or without certain information.
          </p>
          <div className="flex justify-center">
            <NRNImage
              src={JinjaTemplate}
          ...
          <div className="text-center -mt-4 mb-5 text-xs">
            Jinja if/else statement to render specific element if the response
          ...
          <p className="mt-3">
            ...
            that for some reason IGDB currently does not have any critical
            reviews aggregated for a certain game. I had to do this for the ESRB
            rating as well, as it is possible for the IGDB to have a released
            game in their records, but missing the rating for one reason or
            another.
          </p>
          <h3 className="text-[var(--toastedalmond)] underline decoration-[var(--honey)] mt-3">
          ...
          <p className="mt-3">
            ...
            approximately 6 days. I elected to work ahead of the class material
            as to give myself as much time needed to complete the project.
            Easing my future school work debt made this project incredibly
            manageable!
          </p>
        </div>
      </div>
